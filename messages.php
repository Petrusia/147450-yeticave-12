...
const LOT_DATE_FORMAT_ERR = 'Неверный формат даты.';
const LOT_MIN_TIME_ERR = 'Дата должна быть не меньше, чем ';
const LOT_MAX_TIME_ERR = 'Дата должна быть не более, чем ';
