...
<main>
    ...
    <form class="form form--add-lot container  <?= $formErrors ? 'form--invalid' : '' ?>"
        ...
        <div class="form__container-two">
            ...
            <div class="form__item <?= $formErrors['lot-category'] ? 'form__item--invalid' : '' ?>>
        ...
        <div class="form__item form__item--wide <?= $formErrors['lot-message'] ? 'form__item--invalid' : '' ?>">
        ...
        <div class="form__item form__item--file <?= $formErrors['lot-img'] ? 'form__item--invalid' : '' ?>">
        ...
        <div class="form__container-three ">
            <div class="form__item form__item--small <?= $formErrors['lot-rate'] ? 'form__item--invalid' : '' ?>">
            ...
            <div class="form__item form__item--small <?= $formErrors['lot-step'] ? 'form__item--invalid' : '' ?>">
            ...
            <div class="form__item <?= $formErrors['lot-date'] ? 'form__item--invalid' : '' ?>">
