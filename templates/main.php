        ...
        <ul class="promo__list">
            ...
            foreach ($categories as $category) : ?>
                <li class="promo__item promo__item--<?= $category['category_alias']; ?>">
                    <a class="promo__link" href="pages/all-lots.html"><?= h($category['category_name']) ?></a>
                </li>
            <?php
            endforeach; ?>
        </ul>
            ...
            foreach ($lots as $lot) :?>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?= h($lot['lot_img']) ?>" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        ...
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount"><?= h($lot['lot_price']) ?></span>
